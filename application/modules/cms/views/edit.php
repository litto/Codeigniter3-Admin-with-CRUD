	...
	<?php echo form_hidden($csrf); ?>
						...
						<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="form-field-1" placeholder="Page Name"  name="txtMenuTitle" value="<?php echo $record[0]["title"];?>"  class="col-xs-12 col-sm-12" />
									</div>
								</div>
				...
				<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
											<input type="file" id="id-input-file-2" name="txtFile"/> <img src="<?php echo base_url(); ?>uploads/<?php echo $record[0]['banner'];?>" width="150px" height="150px" alt="" >
									</div>
								</div>
...
<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										 ...
										 <option value="0" <?php if($record[0]["parent"]==0){?> selected="selected"<?php }?>>-------Top-------</option>
                            <?php
                            foreach($parentList as $ind=>$val){   //loop 1 start
                                $sub    =   $val["items"];
                                ?>
                                <option value="<?php echo $val["id"]?>" <?php if($record[0]["parent"]==$val["id"]){?> selected="selected"<?php }?>><?php echo $val["title"]?>
                                </option>                               
                                <?php
                                if(count($sub)>0){ //if1
                                    ...
                                    <optgroup>
                                        ...
                                        foreach($sub as $indd=>$vall){ //for 2
                                            $subb   =   $vall["items"];
                                            ?>
                                            <option value="<?php echo $vall["id"]?>" <?php if($record[0]["parent"]==$vall["id"]){?> selected="selected"<?php }?> ><?php echo $vall['title'];?></option>
                                            <?php
                                            if(count($subb)>0)  {
                                                foreach($subb as $inddd=>$valll){
                                                    ?>
                                                     <option value="<?php echo $valll["id"]?>" <?php if($record[0]["parent"]==$valll["id"]){?> selected="selected"<?php }?> > &nbsp;&nbsp;&nbsp;--<?php echo $valll['title'];?></option>
                                                    <?php
                                                }
                                            }
			...
			<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="form-field-1" placeholder="Page Title" name="txtTitle"  value="<?php echo $record[0]["page_title"];?>"  class="col-xs-12 col-sm-12" />
									</div>
								</div>
...
<div class="row">
      		...
      		<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
									<textarea name="txtContent" id="description" rows="5" cols="80"><?php echo $record[0]["content"];?></textarea>
									</div>
								</div>
...
<?php
$titlecount=strlen($record[0]['seo_title']);
$remainingtitlecount=70-$titlecount;


$desccount=strlen($record[0]['seo_description']);
	...
	<div class="row">
			<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
									<input type="text" name="seo_title" id="seo_title" onkeyup="countseotitle()" class="form-control" maxlength="70" value="<?php echo $record[0]['seo_title']; ?>">
									</div>
...
<div class="row">
       	<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
											<textarea id="form-field-tags"   name="seo_keywords" class="autosize-transition form-control"><?php echo $record[0]['seo_keywords']; ?></textarea>
								</div>
								</div></div>
<div class="row">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
									<input type="text" name="seo_slug" class="form-control" maxlength="70" value="<?php echo $record[0]['seo_slug']; ?>">
									</div>
...
<div class="row">
     		...
     		<div class="col-xs-12">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
								<textarea id="seo_description" onkeyup="countseodescription()"  maxlength="160" name="seo_description" class="autosize-transition form-control"><?php echo $record[0]['seo_description']; ?></textarea>
