...
if($message!=''){
 ...
 ?>
            ...
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>auth/change_password">
 ...
 <input type="hidden" name="user_id"   value="<?php echo $user_id;?>" />
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <div class="col-sm-8">
                                                            <input type="password" id="form-field-1"   name="old_password"  class="col-xs-12 col-sm-12" />
                                                      </div>
                                                </div>
...
<div class="col-xs-4">
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <div class="col-sm-8">
                                                            <input type="password" id="form-field-1" pattern="^.{' . $min_password_length . '}.*$" name="new_password"  placeholder="New Password"  class="col-xs-12 col-sm-12" />
                                                      </div>
                                                </div>
                                    ...
                                    <div class="col-xs-4">
                                                <!-- #section:elements.form -->
                                                <div class="form-group">
                                                      <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Confirm New Password </label>

                                                      <div class="col-sm-8">
                                                            <input type="password" id="form-field-1" pattern="^.{' . $min_password_length . '}.*$"  name="new_password_confirm"  placeholder="Confirm Password" class="col-xs-12 col-sm-12" />
                                                      </div>
                                                </div>
