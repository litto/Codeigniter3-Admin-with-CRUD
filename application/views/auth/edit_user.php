...
if($message!=''){
 ...
 ?>
        ...
        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>auth/edit_user/<?php echo $id; ?>">
...
<div class="col-xs-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="form-field-1"   name="first_name" value="<?php echo $user->first_name; ?>"  class="col-xs-12 col-sm-12" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="form-field-1"   name="last_name"   value="<?php echo $user->last_name; ?>" class="col-xs-12 col-sm-12" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="email" id="form-field-1" name="email"  placeholder="Email" value="<?php echo $user->email; ?>"  class="col-xs-12 col-sm-12" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="form-field-1"   name="identity" class="col-xs-12 col-sm-12" value="<?php echo $user->username; ?>" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="form-field-1" name="company"  placeholder="Company"  value="<?php echo $user->company; ?>" class="col-xs-12 col-sm-12" />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" id="form-field-1" name="phone"  placeholder="Telephone" value="<?php echo $user->phone; ?>"   class="col-xs-12 col-sm-12" />
                  </div>
                </div>
...
<div class="row">
 <div class="col-xs-4">
  <div class="form-group">
    ...
    <label class="col-sm-4 control-label no-padding-right" for="form-field-1"> Groups </label>
    <div class="col-sm-8">
